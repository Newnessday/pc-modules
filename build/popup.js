...
/***/ function(module, exports, __webpack_require__) {
	...
	var popup = {
	    ...
	    appendBtn: function appendBtn(selfConfig) {
	    ...
	    bind: function bind(selfConfig) {
	        var _this = this;

	        var closeFun = function closeFun() {
	            return _this.animation();
	        };
	        var confirmFun = function confirmFun() {
	        ...
	        _event.event.on('#J-popup-close', closeFun);
	        if (selfConfig.btnOk) {
	            _event.event.on('#J-popup-confirm', confirmFun);
	        };
	        if (selfConfig.btnCancel) {
	            _event.event.on('#J-popup-cancel', cancelFun);
	        };
	    },
