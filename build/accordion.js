...
/***/ function(module, exports, __webpack_require__) {
	...
	var event = {
	    ...
	    on: function on(eventEle, eventFun) {
	        var eventWrap = arguments.length <= 2 || arguments[2] === undefined ? $(document) : arguments[2];
	        var eventType = arguments.length <= 3 || arguments[3] === undefined ? 'click' : arguments[3];
	    ...
	    //移除事件
	    off: function off(eventEle) {
	        var eventType = arguments.length <= 1 || arguments[1] === undefined ? 'click' : arguments[1];
	        var eventWrap = arguments.length <= 2 || arguments[2] === undefined ? $(document) : arguments[2];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var accordion = function accordion(options) {
	    ...
	    this.core = function (self) {
	        ...
	        self.siblings().removeClass('active').stop().animate(selfConfig.accStyle[accVerticalValue][1], selfConfig.accSpeed).end().stop().animate(selfConfig.accStyle[accVerticalValue][0], selfConfig.accSpeed).addClass('active');
	    };
	    ...
	    !function (self) {
	        ...
	        _event.event.on(selfConfig.accEle, function () {
	            self.core($(this));
